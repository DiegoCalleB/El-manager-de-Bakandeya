...
"Generando copys identitarios de la banda y hashtags con Gemini..."
 ...
 {/* Seccion de Cabecera */}
 <div className={`${colors.card} p-5 space-y-4`}>
 <div className={` pb-3 flex flex-col md:flex-row md:items-center justify-between gap-3 ${isStitchLight ? '-slate-100' : '-[#99907c]/15'}`}>
 <div>
 <h3 className={`text-sm font-bold font-display uppercase tracking-widest flex items-center gap-1.5 ${isStitchLight ? 'text-indigo-600' : 'text-[#f2ca50]'}`}>
 ...
 className={`px-2 py-1 rounded font-mono text-[10px] tracking-wider uppercase font-bold flex items-center gap-1.5 shrink-0 cursor-pointer ${
 isScanningMetrics
 ? 'opacity-50 cursor-not-allowed'
 : isStitchLight
 ? 'bg-emerald-50 hover:bg-emerald-100 -emerald-200 text-emerald-700'
 : 'bg-[#153a15] hover:bg-[#1a4b1a] -emerald-900 text-emerald-300'
 }`}
 >
 ...
 ? 'opacity-50 cursor-not-allowed'
 : isStitchLight
 ? 'bg-slate-50 hover:bg-slate-100 -slate-200 text-slate-700'
 : 'bg-[#1c1b1b] hover:bg-[#2c2b2b] -neutral-800 text-neutral-300'
 }`}
 >
 ...
 {metricSuccess && (
 <div className="p-2.5 bg-emerald-500/10 -emerald-500/20 rounded-lg text-emerald-400 text-xs text-center font-mono animate-bounce flex items-center justify-center gap-1.5">
 <Check className="w-3.5 h-3.5 text-emerald-400" />
 ...
 {/* Net Growth */}
                <div className={`p-4 md:col-span-2 rounded-xl ${isStitchLight ? 'bg-slate-50/50 -slate-100' : 'bg-neutral-900/40 -neutral-900'}`}>
 ...
 {metrics.length > 0 && (
 <div className={`p-4 rounded-xl ${isStitchLight ? 'bg-slate-50/50 -slate-100' : 'bg-[#131313]/50 -neutral-900'}`}>
 ...
 isStitchLight ? 'bg-slate-50/50 -slate-100' : 'bg-[#101010] -neutral-800'
 }`}
 >
 ...
 isStitchLight
 ? '-slate-200 text-slate-600 bg-slate-50 hover:bg-slate-100'
 : '-neutral-800 text-neutral-400 bg-neutral-900 hover:bg-neutral-850'
 }`}
 >
 Cancelar
 </button>
 ...
 <thead>
 <tr className={` text-neutral-400 uppercase tracking-wider text-[8px] ${isStitchLight ? '-slate-100' : '-neutral-900'}`}>
 ...
 className="p-1 hover:text-indigo-400 transition-colors cursor-pointer bg-transparent -none text-neutral-500"
 title="Editar fila"
 >
 ...
 className="p-1 hover:text-rose-500 transition-colors cursor-pointer bg-transparent -none text-neutral-500"
 title="Eliminar fila"
 >
