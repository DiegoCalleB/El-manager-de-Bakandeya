...
export default function Finanzas({ colors, payments = [], onAddPayment, onUpdatePayment }: FinanzasProps) {
 ...
 <div className={`w-full max-w-md rounded-2xl p-6 space-y-4 shadow-2xl relative overflow-hidden ${
 isStitchLight ? 'bg-white -slate-200 text-slate-850' : 'bg-[#1c1b1b] -neutral-800 text-neutral-100'
 }`}>
 <div className="flex justify-between items-center pb-3 -neutral-800">
 ...
 className={`py-2 px-3 rounded-lg font-mono font-bold uppercase transition-all cursor-pointer ${
 tipo === 'ingreso'
 ? 'bg-emerald-500/15 -emerald-500/40 text-emerald-400'
 : 'bg-neutral-900/50 -neutral-800 text-neutral-500 hover:text-neutral-300'
 }`}
 >
 Ingreso (+)
 </button>
 ...
 className={`py-2 px-3 rounded-lg font-mono font-bold uppercase transition-all cursor-pointer ${
 tipo === 'gasto'
 ? 'bg-rose-500/15 -rose-500/40 text-rose-400'
 : 'bg-neutral-900/50 -neutral-800 text-neutral-500 hover:text-neutral-300'
 }`}
 >
 Gasto (-)
 ...
 className={`w-full rounded-lg px-3 py-2 focus:outline-none font-mono ${
 isStitchLight ? 'bg-slate-50 -slate-200 text-slate-800' : 'bg-neutral-950 -neutral-800 text-neutral-100 focus:-[#f2ca50]'
 }`}
 />
 </div>
 ...
 className={`rounded-lg font-mono font-bold uppercase transition-all cursor-pointer flex items-center justify-center ${
 estado === 'pendiente'
 ? 'bg-amber-500/15 -amber-500/40 text-amber-400 text-[10px]'
 : 'bg-neutral-900/50 -neutral-800 text-neutral-500 text-[10px] hover:text-neutral-300'
 }`}
 >
 Pendiente
 </button>
 ...
 className={`rounded-lg font-mono font-bold uppercase transition-all cursor-pointer flex items-center justify-center ${
 estado === 'pagado'
 ? 'bg-emerald-500/15 -emerald-500/40 text-emerald-400 text-[10px]'
 : 'bg-neutral-900/50 -neutral-800 text-neutral-500 text-[10px] hover:text-neutral-300'
 }`}
 >
 Liquido
 ...
 <div className="flex gap-3 pt-4 -neutral-800">
 <button
 type="button"
 onClick={() => setIsAddOpen(false)}
 className={`w-1/3 py-2 font-mono rounded-lg transition-all text-center cursor-pointer ${
 isStitchLight ? 'bg-slate-50 -slate-200 text-slate-500' : 'bg-neutral-900 -neutral-800 text-neutral-400 hover:text-neutral-200'
 }`}
 >
 Cancelar
 </button>
