# 🤖 MEMORIA Y DIRECCIÓN DE PROMPTS PARA AGENTES IA (BAKANDEYA)
...
```text
Tono profesional, cercano y apasionado por el directo. Enfócate en la facilidad logística del cuarteto, la rápida prueba de sonido y la energía del violín en vivo. Adapta el mensaje al aforo y estilo de la sala.
```

#### ✉️ Asunto por Defecto:
`Propuesta de concierto 2026: Bakandeya en {{nombre_sala}}`

#### 📜 Cuerpo de la Plantilla Base:
```text
Hola equipo de booking de {{nombre_sala}},
...
#### 📝 Historial de Aprendizajes de la Categoría:
  1. [8/11/2026] (Tono: 5/5 ⭐ | Contenido: 5/5 ⭐) Mencionamos explícitamente el cuarteto y la agilidad logística sin vientos.
...
#### 💡 Pautas de Redacción IA para Agentes:
```text
Tono enérgico, enfocado al impacto en festival y grandes aforos. Destaca el ritmo bailable, la conexión con el público y la rapidez en cambios de escenario.
```

#### ✉️ Asunto por Defecto:
`Propuesta de contratación para cartel 2026: Bakandeya (Balkan-Ska Live Set)`

#### 📜 Cuerpo de la Plantilla Base:
```text
Estimada organización de {{nombre_sala}},
...
#### 💡 Pautas de Redacción IA para Agentes:
```text
Tono moderno, enfocado a clubes y discotecas de noche. Resalta que no somos un grupo tradicional sino un Live Set electrónico bailable perfecto para la madrugada.
```

#### ✉️ Asunto por Defecto:
`Propuesta Electro-Balkan Live Set: Bakandeya en {{nombre_sala}}`

#### 📜 Cuerpo de la Plantilla Base:
```text
Hola equipo de programación de {{nombre_sala}},
...
#### 💡 Pautas de Redacción IA para Agentes:
```text
Tono periodístico, profesional y directo para medios de comunicación (Radio 3, podcasts, prensa escrita, blogs). Dirígete al redactor, locutor o equipo de prensa. Destaca el violín y la electrónica. IMPORTANTE: No pidas fechas de conciertos ni taquillas.
```

#### ✉️ Asunto por Defecto:
`[Nota de Prensa / Dossier] Bakandeya presenta su nuevo videoclip y gira 2026`

#### 📜 Cuerpo de la Plantilla Base:
```text
Hola equipo de redacción de {{nombre_sala}},
...
#### ✉️ Asunto por Defecto:
`Propuesta de concierto compartido e intercambio de fechas: Bakandeya x {{nombre_sala}}`

#### 📜 Cuerpo de la Plantilla Base:
```text
¡Buenas chavales de {{nombre_sala}}!
...
#### ✉️ Asunto por Defecto:
`Propuesta de colaboración / Roster: Bakandeya (Balkan-Ska Electro-Live)`

#### 📜 Cuerpo de la Plantilla Base:
```text
Estimado equipo de {{nombre_sala}},
